...
1. Visit [{{BASE_URL}}/account]({{BASE_URL}}/account)
2. Sign up with email + password or Google
3. Verify your email
4. Your API key is generated automatically

Your key and usage stats are available on the [account dashboard]({{BASE_URL}}/account).
...
You can explore satellite data without signing up using the [Satellite Catalog Explorer]({{BASE_URL}}/explore/). Click any object to view its current orbital elements, and log in to access full historical data.
